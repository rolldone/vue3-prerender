 ...
 * 2018-07-02T00:23:51
 */
!(function(e, n, t, r, i, o, s, c, a, u, l, d, p, m) {
  for (
    (l = e.ionicons = e.ionicons || {}).components = a,
      (p = a
        .filter(function(e) {
          return e[2];
        })
        ...
        (((d = n.createElement("style")).innerHTML = p.join() + "{visibility:hidden}.hydrated{visibility:inherit}"), d.setAttribute("data-styles", ""), n.head.insertBefore(d, n.head.firstChild)),
      (function(e, n, t) {
  ...
  (p = m.getAttribute("data-resources-url")),
    !i && p && (i = p),
    !i && m.src && (i = (p = m.src.split("/").slice(0, -1)).join("/") + (p.length ? "/" : "") + "ionicons/ionicons/"),
    ...
    (function(e, n, t, r) {
      ...
      ? (d.src = i + "ionicons.dex2bneu.js")
      : ((d.src = i + "ionicons.vparyxzd.js"), d.setAttribute("type", "module"), d.setAttribute("crossorigin", !0)),
